...
describe('eMerchantPay Order API', function () {
    ...
    describe('Cancelrebill', function () {
        ...
        var validXML = '<?xml version="1.0" encoding="UTF-8"?><cancelrebill><response>A</response><responsecode>OP1000</responsecode><responsetext>Rebilling cancelled successfully</responsetext></cancelrebill>',
            validJSON = JSON.parse('{"cancelrebill":{"response":"A","responsecode":"OP1000","responsetext":"Rebilling cancelled successfully"}}');
